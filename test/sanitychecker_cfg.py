...
process.MessageLogger = cms.Service("MessageLogger",
    ...
    categories = cms.untracked.vstring("inputChain","decayChain","NoDataFound","LinkBroken_noJetsFound","LinkBroken_noMuonsFound","LinkBroken_noMetsFound","LinkBroken_noGenEvtFound","LinkBroken_ISRJets","LinkBroken_TopRadJets","SummaryError","MainResults"), # list of categories
